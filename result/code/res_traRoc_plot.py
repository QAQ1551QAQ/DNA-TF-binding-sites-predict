...
def draw_roc_pr(fpr_1, tpr_1, recall_1, precision_1, roc_auc_1, pr_auc_1,
    ...
    plt.title('ROC AUC')
    plt.plot(fpr_2, tpr_2, 'm',label='BiLSTM = %0.3f'% roc_auc_2)
    plt.plot(fpr_3, tpr_3, 'g',label='CNN = %0.3f'% roc_auc_3)
    # plt.plot(fpr_5, tpr_5, 'orange',label='DeepD2V = %0.3f'% roc_auc_5)
    plt.plot(fpr_4, tpr_4, 'c',label='BiGRU = %0.3f'% roc_auc_4)
    ...
    plt.title('PR AUC')
    plt.plot(recall_2, precision_2, 'm',label='BiLSTM = %0.3f'% pr_auc_2)
    plt.plot(recall_3, precision_3, 'g',label='CNN = %0.3f'% pr_auc_3)
    # plt.plot(recall_5, precision_5, 'orange',label='DeepD2V = %0.3f'% pr_auc_5)
    plt.plot(recall_4, precision_4, 'c',label='BiGRU = %0.3f'% pr_auc_4)
...
if __name__ == "__main__":
    ...
    path_res = '../res/traditional_methods/'
    ...
    fpr_2, tpr_2, recall_2, precision_2, roc_auc_2, pr_auc_2 = get_values(np.load(path_res+ 'BiLSTM_11-19_21.13_0.885771905120564.npz'))# BiLSTM
    fpr_3, tpr_3, recall_3, precision_3, roc_auc_3, pr_auc_3 = get_values(np.load(path_res+'CNN_11-19_20.02_0.9014918629054542.npz'))# CNN
    fpr_4, tpr_4, recall_4, precision_4, roc_auc_4, pr_auc_4 = get_values(np.load(path_res+'BiGRU_11-19_21.19_0.905145325572831.npz'))# BiGRU
